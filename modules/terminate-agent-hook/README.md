...
| <a name="input_spot_request_enabled"></a> [spot\_request\_enabled](#input\_spot\_request\_enabled) | Set to false when terminate-agent-hook does not need to handle spot instances. | `bool` | `true` | no |
